...
@ContextConfiguration(classes = {AccountOnBoardingServiceImpl.class, AccountDetailsRepository.class, ActivationCodeRepository.class, NotificationService.class})
